---
layout: post
title: Extinct rules in the Ojibwe(ISO 639-3: oji) Language
...
Ontario and Southern Saskatchewan in Canada [@bloomfield2016eastern]. It
...
[@bloomfield2016eastern]. Ojibwe words can be classified into four main
...
person, obviation, and inclusion [@todd1970grammar]. Nouns are highly
...
articles of clothing [@bloomfield2016eastern]. Ojibwean nouns have
...
prominent/significant/closer proximate (my-son) [@todd1970grammar].
...
noun inflection is documented by R. @valentine2001nishnaabemwin, when he
...
according to R. @valentine2001nishnaabemwin is one of the reasons why
...
::: center
    Basic Form    Initial-Inflection                      English
  -------------- -------------------- -----------------------------------------------
...
@valentine2001nishnaabemwin's extensive grammar of Ojibwe, certain
...
::: center
   Ojibwe \"Traditional\" Pronunciation   Salteux Vowel Syncope
  -------------------------------------- -----------------------
...
My new rules focused on updating my phonology to be more relevant to
...
NOTE: My added rules include the Salteux Ojibwe Rule Syncope and Glide
rules as above, elision, redoing phonology to fit this one certain
dialect and an adding of an animate-inanimate differentiation in Ojibwe
verbs (applying to animate and inanimate nouns) .

[^1]: Some scholars classify Ojibwe into completely different languages,
